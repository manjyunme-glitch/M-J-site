...
- 首页编排：调整六个首页模块的显示和顺序，修改短句、封面照片、按钮、目录文案、页尾寄语和暗号翻页卡片。
...
照片会记录原始长宽并生成完整内容缩略图。前台会按横图、方图、竖图和手机长截图自动选择稳定画框，详情页可点开查看完整图片。支持 JPEG、PNG、WebP，单张最大 15MB。音乐支持 MP3、M4A、OGG，最大 30MB。
